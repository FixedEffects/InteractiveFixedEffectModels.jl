...
Contrary to the method described in Bai (2009), these methods (i) are faster (ii) accept datasets with more than one observation for a given pair id x time (or weights) (iii) handle datasets where both N and T large
