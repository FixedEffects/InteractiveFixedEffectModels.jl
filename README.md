...
In contrast to the method described in Bai (2009), these methods are faster, accept datasets with more than one observation for a given pair id x time (or weights), and handle cases where both N and T large
