...
function fit_gd!{Rid, Rtime}(X::Matrix{Float64},
                             M::Matrix{Float64},
                             b::Vector{Float64},
                             y::Vector{Float64},
                             idf::PooledFactor{Rid},
                             timef::PooledFactor{Rtime},
                             sqrtw::AbstractVector{Float64}; maxiter::Integer = 100_000,
                             tol::Real = 1e-9,
                             lambda::Real = 0.0)
...
function fit_ar!{Rid, Rtime}(X::Matrix{Float64}, 
                             M::Matrix{Float64}, 
                             b::Vector{Float64}, 
                             y::Vector{Float64}, 
                             idf::PooledFactor{Rid}, 
...
function fit_svd!{Rid, Rtime}(X::Matrix{Float64},
                              M::Matrix{Float64},
                              b::Vector{Float64},
                              y::Vector{Float64},
                              idf::PooledFactor{Rid},
